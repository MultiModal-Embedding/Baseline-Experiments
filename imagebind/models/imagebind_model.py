...
def imagebind_huge(pretrained=False):
    ...
    if pretrained:
        if not os.path.exists("./download/models/imagebind_huge.pth"):
            print(
                "Downloading imagebind weights to ./download/models/imagebind_huge.pth ..."
            )
            # os.makedirs(".checkpoints", exist_ok=True)
            torch.hub.download_url_to_file(
                "https://dl.fbaipublicfiles.com/imagebind/imagebind_huge.pth",
                "./download/models/imagebind_huge.pth",
                progress=True,
            )

        model.load_state_dict(torch.load("./download/models/imagebind_huge.pth"))
